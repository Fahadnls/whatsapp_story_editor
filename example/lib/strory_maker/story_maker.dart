...
// import 'package:lk_li_app/screens/story_edit/controller/editing_controller.dart';
// import 'package:lk_li_app/screens/story_edit/controller/utils.dart';
...
//     final left = (delta.dx / Get.width) + _currentPos.dx;
//     final top = (delta.dy / Get.height) + _currentPos.dy;
...
//     _isLoading = true;
//     setState(() {});
//     RenderRepaintBoundary repaintBoundary = previewContainer.currentContext!
...
//     final imgFile = await tempFile.writeAsBytes(memoryImage.bytes.toList());
...
//     // final image = await boundary!.toImage(pixelRatio: 3);
//     // final byteData = await image.toByteData(format: ui.ImageByteFormat.png);
//     // final imageData = MemoryImage(byteData!.buffer.asUint8List());
//     // if (context.mounted) {
//     //   Navigator.pop(context, imageData);
//     // }
//     Get.find<EditingController>().backgroundImage = imgFile;
//     // Get.find<EditingController>(). = imgFile;
//     setState(() {});
